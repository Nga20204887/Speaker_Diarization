...
def create_config(output_dir,file_name):
    ...
    MODEL_CONFIG = "/home/hungha/AI_365/phantachgiong/cfg/diar_infer_telephonic.yaml"
    ...
    meta = {
        "audio_filepath": os.path.join(output_dir, file_name),
        "offset": 0,
        "duration": None,
        "label": "infer",
        "text": "-",
    ...
    config.diarizer.clustering.parameters.oracle_num_speakers = 2
    ...
    config.diarizer.msdd_model.model_path = (
        "/home/hungha/AI_365/phantachgiong/model/MultiscaleDiarDecoder--val_loss=5.1801-epoch=1.ckpt"  # Telephonic speaker diarization model
    )
